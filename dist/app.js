...
const ClientSocket_1 = require("./sockets/ClientSocket");
...
class App {
    ...
    setRoutes() {
        ...
        this.app.use('/chat', index_1.ChatRouter);
        this.app.use('/operator', index_1.OperatorRouter);
    ...
    async start() {
        try {
            ...
            new ClientSocket_1.ChatSocket(io);
            // Запуск сервера
